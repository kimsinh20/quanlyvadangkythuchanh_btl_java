 ...
 * @author ADMIN
 */
public class viewBaoCaoTheoTuan extends javax.swing.JFrame {

    /**
     * Creates new form viewBaoCaoTheoTuan
     */
    public viewBaoCaoTheoTuan() {
        initComponents();
        new Thread(() -> {
            comboTuan.setSelectedItem(String.valueOf(DBQuanLyThucHanh.getTuanNay()));
        }).start();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BÁO CÁO THEO TUẦN");
    ...
    public void xuatBaoCaoTheoTuan(String ngay, int tuan, String path) {
        ...
        XSSFSheet spreadsheet = workbook.createSheet("Tuần 1");
        XSSFRow row;
...
//                System.out.println("yes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewBaoCaoTheoTuan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
